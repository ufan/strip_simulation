...
//paddle 
 ...
 //----------------------- head_Con
  ...
  G4double  pRmax1 = sqrt(401)*5*mm;
  G4double  pRmin2 = 0 *mm;
  G4double  pRmax2 = 30*mm;
  G4double  pDConz =2.5*mm;
...
//-------------------------down box
  G4double pdbz=0*mm;
/*  G4Box* down_box = new G4Box("down_box",dx1+0.0*mm,dy1+0.0*mm,pdbz+0.0*mm);
